  ...
  return (
    <div className="flex relative">
      ...
      <div className="bg-[#21201E] min-h-screen md:ml-72 w-full">
        ...
        {/* Top Rated */}
        <div className="p-5">
          <h2 className="text-white text-2xl font-bold">Top Rated Series</h2>
          <TopRated />
        </div>
        {/* Now Playing */}
        <div className="p-5">
        ...
        {/* Popular Movies */}
        <div className="p-5">
          <h2 className="text-white text-2xl font-bold">Popular Series</h2>
          <TrendingCategory />
        </div>
        {/* Upcoming Movies */}
        <div className="p-5">
          <h2 className="text-white text-2xl font-bold">Upcoming Series</h2>
          <UpcomingMovies />
        </div>
      </div>
    </div>
